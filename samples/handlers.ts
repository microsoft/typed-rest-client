...
export async function run() {
    ...
    var url = "http://stephenmichaelf:8080/tfs/DefaultCollection/_apis/connectionData";
    ...
    const response: ifm.IHttpClientResponse = await httpClient.get(url);
    console.log("response codeeeeeeeeeeee: " + response.message.statusCode);
    console.log("body " + await response.readBody());
}
